...
*   **何时失效？** 策略淘汰的判断已通过**硬性死亡条款**量化（见第5节），不依赖主观经验。
---
...
### 5.3 盘感的唯一合法用途 (The Soft Cage)
在量化体系中，盘感（直觉）只允许用于：
1.  **研发阶段**：构思新策略逻辑，量化与判断回测逻辑是否合理。
2.  **外部不可抗力**：交易所跑路、监管突变、标的归零、小行星撞地球等“物理毁灭”事件。
