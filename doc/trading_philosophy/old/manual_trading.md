# [已废弃] 散户手动交易哲学：扫描器 + 盘感 (DEPRECATED)

> **注意：此文档已归档，内容已过时。请参阅最新的 [交易哲学](./manual_trading.md) 了解最新的盘感与扫描理论。**
...
4.  **禁止加仓与反手**：
    ...
    *   **仓位管理**：开仓前就必须决定好最终仓位。保证金占资金比例应该在 **40%-60%**。如果小于这个比例, 可以多下几手, 直直到符合比例, 如果超过这个比例, 哪怕机会再好也不开仓, 风控在进场前就计算好。
