...
from py_entry.strategy_hub.test_strategies.reversal_extreme.btp import (
    ReversalExtremeBtp,
)
from py_entry.strategy_hub.test_strategies.reversal_extreme.config import CONFIG as C
